...
/**
 * This class contains a method that remove session user. Servlet will directly
...
public class LogoutController extends HttpServlet {
    ...
    /**
     * This method that remove session user. Servlet will directly respond to
     * "Error.jsp" when any error occurs
     *
     * @param request stores attributes: session user, error to send to JSP It
     * is a <code> javax.servlet.http.HttpServletRequest
     * </code>
